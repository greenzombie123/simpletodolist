...
const createProjectBox = () => {
    ...
    let setProjectNamesOnOpen = (projectNames) => {
        while (projectSelect.childElementCount) {
            projectSelect.removeChild(projectBox.firstChild);
        }
