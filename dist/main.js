...
const toDoApp = (() => {
    ...
    const initialize = () => {
        tasks.push({ title: "Do the dishes", description: "Do it soon!", dueDate: new Date().toISOString().slice(0, 10), priority: Priority.None, project: "Inbox", id: (0, uuid_1.v4)(), isCompleted: false });
        tasks.push({ title: "Do the dishes now", dueDate: "2024-08-10", priority: Priority.None, project: "Inbox", id: (0, uuid_1.v4)(), isCompleted: false });
        tasks.push({ title: "Do the dishes yesterday", dueDate: "2025-12-11", priority: Priority.None, project: "Inbox", id: (0, uuid_1.v4)(), isCompleted: false });
        tasks.push({ title: "Do the dishes today!", dueDate: "2024-02-27", priority: Priority.High, project: "School", id: (0, uuid_1.v4)(), isCompleted: false });
        tasks.push({ title: "Do the dishes today!", dueDate: "2024-05-02", priority: Priority.Low, project: "Ice", id: (0, uuid_1.v4)(), isCompleted: false });
